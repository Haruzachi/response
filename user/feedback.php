      ...
      <ul class="space-y-1 mt-1">
        ...
        <li>
          <button class="flex items-center w-full p-2 hover:bg-blue-800 rounded justify-between module-btn transition-colors duration-200" data-target="module1">
            <span class="flex items-center"><i class='bx bx-bell text-xl'></i><span class="ml-2">Feedback</span></span>
          ...
          <ul class="max-h-0 overflow-hidden flex-col transition-all duration-500 ml-4 submodule" id="module1">
            <li><a href="./feedback.php" class="flex items-center text-sm p-1 hover:text-blue-200"><i class='bx bx-user'></i><span class="ml-1">Feedback User</span></a></li>
          </ul>
        </li>
...
<button id="menuBtn" class="md:hidden p-2 text-white bg-blue-950">
  <i class='bx bx-menu text-2xl'></i>
    ...
    <h1 class="font-bold text-base sm:text-lg md:text-xl lg:text-2xl text-white flex-1 truncate">
      --// <?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Feedback'; ?> //--
    </h1>
  </div>
