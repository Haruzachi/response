...
<body>
  ...
  <div id="loading-screen">
    ...
    <div class="loading-text">STARTING THE PROGRAM...</div>
    <div class="loading-sub">Please wait a little longer</div>
  </div>
  ...
  <script>
    window.addEventListener("load", function() {
      setTimeout(() => {
        window.location.href = "./index/dashboard.php#home"; // Redirect to the main dashboard
      }, 3000); // 3-second delay
    });
  </script>
