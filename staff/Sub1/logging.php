      ...
      <ul class="space-y-1 mt-1">
        ...
        <li>
          ...
          <ul class="max-h-0 overflow-hidden flex-col transition-all duration-500 ml-4 submodule" id="module1">
            <li><a href="#" class="flex items-center text-sm p-1 hover:text-blue-200"><i class='bx bx-user'></i><span class="ml-1">Caller Information</span></a></li>
          </ul>
        </li>
...
<script src="https://cdn.tailwindcss.com"></script>
  ...
  <style>
    #map {
    height: calc(108vh - 108px); /* same as your container div */
