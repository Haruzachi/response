...
$pageTitle = "Reports on Resource Utilization";
...
$sql = "
SELECT ec.*, r.unit_name, r.resource_type, ra.assigned_at
...
<head>
  ...
  <title>Reports on Resource Utilization</title>
      ...
      <ul class="space-y-1 mt-1">
        ...
        <li>
          ...
          <ul class="max-h-0 overflow-hidden flex-col transition-all duration-500 ml-4 submodule" id="module3">
            ...
            <li><a href="#" class="flex items-center text-sm p-1 hover:text-blue-200"><i class='bx bx-bar-chart'></i><span class="ml-1">Reports on resource utilization</span></a></li>
          </ul>
        </li>
...
<div class="container mx-auto bg-white p-6 rounded shadow">
    <h1 class="text-2xl font-bold mb-4">Emergency Call Reports</h1>
    ...
    <table class="w-full border">
        <thead class="bg-gray-200">
            <tr>
                ...
                <th class="border p-2">Call Created At</th>
                <th class="border p-2">Unit Assigned At</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="border p-2"><?= htmlspecialchars($call['status']) ?></td>
                <td class="border p-2"><?= $call['created_at'] ?></td>
                <td class="border p-2"><?= $call['assigned_at'] ?? '-' ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
